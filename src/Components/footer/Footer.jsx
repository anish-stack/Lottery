...
<footer className="bg-orange-500 dark:bg-gray-900">
      ...
      <div>
        ...
        <div>
            ...
            <ul className="text-white dark:text-black font-medium">
                ...
                <li className="mb-4">
                    <a href="/Games-Rules" className="hover:underline">Game-Rules</a>
                </li>
                <li className="mb-4">
                    <a href="/term" className="hover:underline">Terms &amp; Conditions</a>
                </li>
            </ul>
        </div>
        {/* <div>
    ...
    <div className="px-4 py-6 bg-gray-100 dark:bg-gray-700 md:flex md:items-center md:justify-between">
        <span className="text-sm text-black dark:text-gray-300 sm:text-center">© 2024 <a href="https://flowbite.com/">Jackpot Lamp</a>. All Rights Reserved.
        </span>
