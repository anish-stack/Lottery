...
const Privacy = () => {
    return (
        <div className='max-w-7xl mx-auto'>
            <h1 className='text-4xl p-2 text-center font-bold'>PRIVACY POLICY</h1>
            <p>
                Privacy Policy
                Last updated: March 30, 2024
                This Privacy Policy describes Our policies and procedures for the collection, use, and disclosure of Your information when You use the Platform (Jackpotlamp Website or App) and tells You about Your privacy rights and how the law protects You.
                ...
                The words for which the initial letter is capitalized have meanings defined under the following conditions: The following definitions shall have the same meaning regardless of whether they appear in singular or plural.
                ...
                Website refers to Jackpotlamp, accessible from www.jackpot.com.
                ...
                We use Cookies and similar tracking technologies to track activity on Our Platform and store certain information. Tracking technologies used are beacons, tags, and scripts to collect and track information and to improve and analyze Our Platform. The technologies We use may include:
                ...
                Google Analytics has Advertising Reporting Features activated on this Platform, which collects additional information from the DoubleClick cookie (web activity) and from device advertising IDs (app activity). It allows the Owner to analyze specific behavior and interest Data (traffic Data and Users' ad interaction Data) and, if enabled, demographic Data (information about the age and gender of Users).

                Users can opt out of Google's use of Cookies by visiting Google's Ads Settings. Personal Data processed: Cookies; unique device Identifiers for advertising (Google Advertiser ID or IDFA, for example); various types of Data as specified in the privacy policy of the service. Place of Processing: United States – Privacy Policy – Opt-Out. Privacy Shield participant.

                Category of personal data collected: Internet information and Identifiers.

                Phone Contact
                Users who provided their telephone number might be contacted for commercial or promotional purposes related to this Platform, as well as for fulfilling support requests.
                ...
                Google Fonts
                Google Fonts is a typeface visualization service provided by Google LLC that allows this Platform to incorporate content of this kind on its pages.
                ...
                YouTube
                YouTube is a video content visualization service provided by Google LLC, whose widget allows this Platform to incorporate video content on its pages.
                ...
                Know & Access: Learn what information we collect, why we use it, and who receives it. Request a portable copy of your data.
                Delete: Ask us to erase your personal information, with some legal exceptions.
                Exercise Your Rights: Submit a verifiable request with your identity and clear details.
                Response & Timeline: We'll confirm receipt, respond within 45 days (up to 90 days if needed), and explain any denials. No fees unless requests are excessive.
                Delete Your Personal Data
                You have the right to delete or request that We assist in deleting the Personal Data that We have collected about You.

                Our Platforms may give You the ability to delete certain information about You from within the Platform.
